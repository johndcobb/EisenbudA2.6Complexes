...
IB = saturate(I,B)
depth(IB,R)
-- So this did not do what I expected it to do. Instead of concentrating on the first row, I think I need to work directly with the ideal of maximal minors.
